...
class ValidaPossiveisCamposNullRespostaValidatorTest {
    ...
    void deveDarErroRespostaNullVazia(){
        ...
        IaResponse respostaII = new IaResponse(null);
        ...
        IaResponse respostaIII = new IaResponse(List.of());

        ResponseStatusException exceptionIII = assertThrows(ResponseStatusException.class, () -> tested.validaNotNull(respostaIII));

        assertEquals(SERVICE_UNAVAILABLE, exceptionIII.getStatusCode());
        assertEquals("Resposta da IA veio vazia ou sem candidatos", exceptionIII.getReason());
    }
    ...
    void deveDarErroContentNullVazia(){
        ...
        IaResponse respostaI = new IaResponse(List.of(new CandidateResponse(null)));
        ...
        IaResponse respostaII = new IaResponse(List.of(new CandidateResponse(new ContentResponse(null))));
        ...
        IaResponse respostaIII = new IaResponse(List.of(new CandidateResponse(new ContentResponse(List.of()))));

        ResponseStatusException exceptionIII = assertThrows(ResponseStatusException.class, () -> tested.validaNotNull(respostaIII));

        assertEquals(SERVICE_UNAVAILABLE, exceptionIII.getStatusCode());
        assertEquals("Candidato da IA sem conteúdo/partes", exceptionIII.getReason());
    }

...
public class ExportarManutencoesService {
    ...
    public byte[] exportar(String tipoPeriodo, String dataReferencia)
        ...
        List<Manutencao> manutencoes =
                manutencaoRepository.findAllByVeiculoIdVeiculoAndIsAtivoAndDataManutencaoBetween(
        ...
        JRBeanCollectionDataSource dataSource =
                new JRBeanCollectionDataSource(manutencoesResponses);

        Map<String, Object> parametros = new HashMap<>();
        parametros.put("createdBy", "DriveX API");
        parametros.put("inicioPeriodo",
                periodoData.dataInicio().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        parametros.put("fimPeriodo",
                periodoData.dataFim().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
